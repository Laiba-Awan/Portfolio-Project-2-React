      ...
      <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active ">
            <div className="slider-img pt-5 pb-5">
              <div className="container d-flex align-items-center justify-content-center mb-5 pt-5 pb-5 container-carousel">
              ...
              <div className="container d-flex align-items-center justify-content-center mb-5 pt-5 pb-5 container-carousel">
                <div className="row d-flex align-items-center justify-content-center">
                  <div class="col-sm-8 col-lg-7 px-5 px-sm-3 d-flex align-items-center flex-column">
                    ...
                    <div>
                      <Link class="btn btn-carousel pt-1 me-3" to="/login">
                        LOG IN
                      </Link>
                      <Link class="btn btn-slider pt-1" to="/">
                        EXPLORE NOW
                      </Link>
                    </div>
                  </div>
                ...
                <div className="row d-flex align-items-center justify-content-center">
                  <div class="col-sm-8 col-lg-7 px-5 px-sm-3 d-flex align-items-center flex-column">
                    ...
                    <div>
                      ...
                      <Link className="btn btn-slider pt-1" to="/">
                        EXPLORE NOW
                      </Link>
                    </div>
                  </div>
